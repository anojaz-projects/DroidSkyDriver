...
/**
 * This utility class handles the file type determination and decides the 
 * corresponding drawable component.
 */
...
public class IOUtil
{
    ...
    public static String findMimeTypeOfFile(File file)
    {
        ...
        {
            /* Unknown file type, so just open it as a plain text file */
            return "text/plain";
        } else
        {
