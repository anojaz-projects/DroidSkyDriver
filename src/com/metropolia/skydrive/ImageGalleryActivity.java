...
public class ImageGalleryActivity extends SherlockActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        /*if (getResources().getConfiguration().orientation ==
        	...
        	setContentView(R.layout.image_gallery);
        	System.out.println("ORIENTATION_PORTRAIT: image_gallery");
        } else {
        	setContentView(R.layout.image_gallery_l);
        	System.out.println("ORIENTATION_LANDSCAPE: image_gallery_l");
        }*/
        ...
        String photoId = photoDetails.getStringExtra("metropolia.skydrive.PHOTO_ID");
        String photoName = photoDetails.getStringExtra("metropolia.skydrive.PHOTO_NAME");
        setTitle(photoName);
        //System.out.println("ImageGalleryActivity --> photoId: " + photoId);
        //System.out.println("ImageGalleryActivity --> photoName: "+ photoName);
            ...
            final LiveDownloadOperation operation =
                    client.downloadAsync(photoId + "/content",
                            ...
                            new LiveDownloadOperationListener()
                            {
                                ...
                                {
                                	//Toast.makeText(getApplicationContext(), getString(R.string.download), Toast.LENGTH_SHORT).show();
                                }
    ...
    /* Note: pressing the Home-button (or rather, not pressing
    ...
    */
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
        	...
        	setContentView(R.layout.image_gallery);
        	//System.out.println("ORIENTATION_LANDSCAPE: image_gallery");
        }
    }
}